...
countries = ['2000.xls', '2001.xls', '2002.xls', '2003.xls', '2004.xls', '2005.xls', '2006.xls', '2007.xls', '2008.xls',
             '2009.xls', '2010.xls', '2011.xls', '2012.xls', '2013.xls', '2014.xls', '2015.xls', '2016.xls', '2017.xls',
             '2018.xls', '2019.xls', '2020.xls', '2021.xls', '2022.xls']

countries_not_on_map = ['Alderney', 'Andorra', 'Bahamas - Off Shore Banking Center', 'Bahrain', 'Bahrain - Off Shore '
                        'Barbados', 'Cayman Islands', 'Cayman Islands - Off Shore Banking Center',
                        ...
                        'Bahrain-Offshore', 'Aruba', 'Banking Center',]
        ...
        for country in countries:
            ...
            for index, row in data.iterrows():
                ...
                if row["Country"] in countries_id_dict.keys():
                    ...
                    if not CountryRiskPremiumItems.objects.filter(year=year, country_id=country_id):
                        data = CountryRiskPremiumItems(year=year, country_id=country_id,
                                                       country_risk_premium=country_risk_premium)
                        data.save()
                        print(country_id, year)
                else:
                    print(country, row["Country"], 'Bląd')
