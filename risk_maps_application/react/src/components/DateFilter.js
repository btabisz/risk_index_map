...
const DateFilter = (props) => {
  ...
  const premiumYearChangeHandler = (event) => {
    props.onChangePremiumYear(event.target.value);
  };
  ...
  return (
    ...
    <Container>
        ...
        <Col  md="auto">
        Year:
        <Form.Select value={props.selectedPremiumYear} onChange={premiumYearChangeHandler}>
          <option value='2022'>2022</option>
          <option value='2021'>2021</option>
          <option value='2020'>2020</option>
          <option value='2019'>2019</option>
